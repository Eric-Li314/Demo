...
$data=$db->execSql("select * from say order by id desc limit 0,10");
$sayList = '';
foreach($data as $k=>$v) {
    $sayList .= formatSay($v['content'], $v['addtime'], $v['userid'],$v['location']);
}
$ip = getIp();
...
<head>
    ...
    <script type="text/javascript" src="file/global.js"></script>
</head>
